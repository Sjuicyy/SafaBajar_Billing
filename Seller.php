                ...
                <div class="row d-flex justify-content-center align-items-center">
                    <div class="col-lg-12 col-md-12 col-sm-12 ">
                        ...
                        <table id="myTable" class="text-center">
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td>
                                                <button type="submit" class="btn btn-sm btn-warning" data-toggle="modal" data-target='#addmodal<?php echo $data["Id"] ?>' title="Edit"><i class="fa-solid fa-pen-to-square fa-lg"></i></button>
                                                ...
                                                <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#Profile_detail<?php echo $data["Id"] ?>"><i class="fa-solid fa-user"></i></button>

                                                <?php
                                                require_once("Connection.php");

                                                $id_seller = $data["Id"];
                                                $id_sql = "SELECT * FROM Stall WHERE  Seller_id=$id_seller";
                                                $id_query = mysqli_query($conn, $id_sql);
                                                $id_result = mysqli_num_rows($id_query);
                                                ?>
                                                ...
                                                ?>
                                                    <a class="btn" href="Delete_user.php?id=<?php echo $data["Id"] ?>">
                                                        <button class="btn btn-sm btn-danger ">Delete</button>
                                                    </a>
                                                <?php
                                                }
                            ...
                            <!-- Edit modal start -->
                            <div class="modal fade" id="addmodal<?php echo $data["Id"] ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered " role="document">
                                    <div class="modal-content">
                                        <form method="POST" action="Edit_seller.php?id=<?php echo $data["Id"]; ?>" enctype='multipart/form-data'>
                                            ...
                                            <div class="modal-body mx-3">
                                                <div class="md-form">
                                                    ...
                                                    <input required type="text" id="Name" value=" <?php echo $data["Name"] ?>" class="form-control" name="Name">
                                                </div>
                                                <div class="md-form">
                                                    <label for="Address">Address: </label>
                                                    <input required type="text" id="Address" value=" <?php echo $data["Address"] ?>" class="form-control" name="Address">
                                                </div>
                                                <div class="md-form">
                                                    <label for="Contact">Contact </label>
                                                    <input required type="text" id="Contact" value="<?php echo $data["Contact"] ?>" class="form-control" name="Contact">
                                                </div>
                                                <div class="md-form">
                                                ...
                                                <div class="md-form">
                                                    ...
                                                    <input type="file" class="form-control-file" id="Citizenship" name="Citizenship" alt="aaa" accept=".jpg, .jpeg, .png">
                                                </div>
                                            </div>
                                            <div class="modal-footer d-flex justify-content-center">
                                                <button type="button" class="btn w-25 btn-danger" data-dismiss="modal">Cancel</button>
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-md-4 pp">
                                                    <img src="./SellerPhotos/<?php echo $data["Photo"] ?>" alt="Profile Picture" class="profile-img">
                                                </div>
                                                <div class="col-md-8">
                                            ...
                                            <div class="row mt-5">
                                                ...
                                                <div class="col-md-8 text-left"><img src="./Citizenship/<?php echo $data["Citizenship"] ?>" alt="Citizenship.pic" width="200px" id="Myimg"></div>
                                                <!--Citizenship Modal -->
                                                    ...
                                                    <div class="modal-dialog modal-lg" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body text-center">
                                                                <img src="./Citizenship/<?php echo $data["Citizenship"] ?>" alt="Citizenship.pic" width="600px" id="Myimg">
                                                            </div>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <form method="POST" action="Add_seller.php" class="modal-content" enctype='multipart/form-data'>
                        ...
                        <div class="modal-body mx-3">
                            ...
                            <div class="md-form">
                                <label for="Photo">Photo: </label>
                                <input required11 type="file" class="form-control-file" id="Photo" name="Photo" accept=".jpg, .jpeg, .png">
                            </div>
                            <div class="md-form">
                                <label for="Citizenship">Citizenship: </label>
                                <input required11 type="file" class="form-control-file" id="Citizenship" name="Citizenship" accept=".jpg, .jpeg, .png">
                            </div>
                        </div>
                        <div class="modal-footer d-flex justify-content-center">
                            <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
